        ...
        <div class="container-fluid container-md">
            <div class="col-auto col-sm-8 offset-sm-2 col-lg-6 offset-lg-3">
                ...
                <div class="p-4 border rounded-3">
                    <form id="myForm" action="/account-management/dashboard/account/add-email" method="post"
                        novalidate>
                        @csrf
                        <!-- header form -->
                        <h1 class="mb-4 text-center text-secondary">Add Email</h1>
                        <!-- end header form -->
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" name="new-email" id="new-email-input" type="text" value=""
                                placeholder="new-email" required />
                            <label for="new-email-input">New Email</label>

                            <!-- username error message -->
                            @isset($errorNewEmailInput)
                                <div class="text-danger"> {{ $errorNewEmailInput }} </div>
                            @endisset
                        ...
                        <div class="form-floating mb-2">
                            <button type="submit" class="btn btn-outline-secondary w-100">Add Email</button>
                        </div>
