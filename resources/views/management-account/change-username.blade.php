        ...
        <div class="container-fluid container-md">
            <div class="col-auto col-sm-8 offset-sm-2 col-lg-6 offset-lg-3">
                ...
                <div class="p-4 border rounded-3">
                    <form id="myForm" action="/account-management/dashboard/account/edit-username" method="post"
                        novalidate>
                        @csrf
                        <!-- header form -->
                        <h1 class="mb-4 text-center text-secondary">Edit Username</h1>
                        <!-- end header form -->

                        <!-- disabled input -->
                        <div class="form-floating mb-3">
                            <input class="form-control opacity-50" name="old-username-display" id="old-username-input"
                                type="text" placeholder="old-username" value="{{ $username ?? " @username_is_not_set"}}"
                                disabled />
                            <label for="old-username-input">Old Username</label>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" name="new-username" id="new-username-input" type="text" value=""
                                placeholder="new-username" required />
                            <label for="new-username-input">New Username</label>

                            <!-- username error message -->
                            @isset($errorNewUsernameInput)
                                <div class="text-danger"> {{ $errorNewUsernameInput }} </div>
                            @endisset
                            <!-- end username error message -->

                            <div class="form-text">Example: @example_username</div>
                        ...
                        <div class="form-floating mb-2">
                            <button type="submit" class="btn btn-outline-secondary w-100">Change Username</button>
                        </div>
